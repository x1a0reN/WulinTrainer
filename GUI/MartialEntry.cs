...
internal class MartialEntry : MonoBehaviour
{
    ...
    public void OnClickAdd()
    {
        ...
        //ToyBox.LogMessage(Data.GetKungfuInfo());
        //ToyBox.LogMessage(Data.GetInternalKungfuEffect(true));
        //ToyBox.LogMessage(Data.InterForceType); // 内功类型
        //ToyBox.LogMessage(Data.KungfuType);
        //foreach (var item in Data.NeedWeaponToCast) {
        //    ToyBox.LogMessage(item);
        //}
        //foreach (var item in Data.CastBuffs)
        //{
        //    ToyBox.LogMessage(item);
        //    ToyBox.LogMessage(GameLoc.Instance.GetLocString($"KungfuCastBuff_{item}"));
        //    ToyBox.LogMessage(GameLoc.Instance.GetLocString($"KungfuCastBuffInfo_{item}"));
        //}
        //ToyBox.LogMessage(GameLoc.Instance.GetLocString($"ItemInfo_{_data.UName}"));
