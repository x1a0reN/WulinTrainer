...
public class InputKeyUGUI : MonoBehaviour
{
    ...
    public Text TextTf;
    public Text KeyNameTf;
    public Text ActiveTextTf;
    ...
    public void Awake()
    {
        ...
        TextTf = transform.Find("NameText").GetComponent<Text>();
        KeyNameTf = transform.Find("KeyWithTextNormal/KeyNameTf").GetComponent<Text>();
        ActiveTextTf = transform.Find("KeyWithTextActive/ActiveTextTf").GetComponent<Text>();
