...
[RegisterInIl2Cpp]
internal class InfinityScrollDlcItemData : InfinityScrollBase
{
    ...
    public InfinityScrollDlcItemData(IntPtr ptr) : base(ptr) { }
    ...
    protected override void UpdateItems(int startIndex)
    {
        for (int i = 0; i < _items.Count; i++)
        {
            ...
            var entry = _items[i].GetComponent<DlcItemEntry>();
            if (entry != null)
            {
